...
class StationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post stations_url, params: { station: { building_id: @station.building_id, minutes_to_walk: @station.minutes_to_walk, railway_name: @station.railway_name, station_name: @station.station_name } }
    end
  ...
  test "should update station" do
    patch station_url(@station), params: { station: { building_id: @station.building_id, minutes_to_walk: @station.minutes_to_walk, railway_name: @station.railway_name, station_name: @station.station_name } }
